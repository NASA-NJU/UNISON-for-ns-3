    ...
    \IfFileExists{9.csv}{
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[ablue, mark=*, thick] table[x=core, y=speedup-barrier, col sep=comma] {9.csv};
                \addplot[ared, mark=*, thick] table[x=core, y=speedup-unison, col sep=comma] {9.csv};
            \end{axis}
        \end{tikzpicture}}{\texttt{9.csv} not found, please run \texttt{./process.py 9} first}
    \caption{\bf Figure 9}
\end{figure}

\begin{figure}[h]
    \IfFileExists{10a.csv}{
        \begin{tikzpicture}
            \begin{axis}[
                    width=\linewidth,
                    height=0.6\linewidth,
                ...
                \addplot+[ablue, draw=none, bar shift=-5pt] table[x=incast, y=exec-barrier, col sep=comma] {10a.csv};
                \addplot+[ablue!60, draw=none, bar shift=-5pt] table[x=incast, y=sync-barrier, col sep=comma] {10a.csv};
                \addbar
                \addplot+[ayellow, draw=none, bar shift=0pt] table[x=incast, y=exec-nullmsg, col sep=comma] {10a.csv};
                \addplot+[ayellow!40, draw=none, bar shift=0pt] table[x=incast, y=sync-nullmsg, col sep=comma] {10a.csv};
                \addbar
                \addplot+[ared, draw=none, bar shift=5pt] table[x=incast, y=exec-unison, col sep=comma] {10a.csv};
                \addplot+[ared!50, draw=none, bar shift=5pt] table[x=incast, y=sync-unison, col sep=comma] {10a.csv};
            \end{axis}
        \end{tikzpicture}}{\texttt{10a.csv} not found, please run \texttt{./process.py 10a} first}
    \caption{\bf Figure 10a}
\end{figure}
    ...
    \IfFileExists{10b.csv}{
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot [ared] table[x=round, y=ratio, col sep=comma] {10b.csv};
            \end{axis}
    ...
    \IfFileExists{11b.csv}{
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot+[ablue, draw=none, bar shift=-12pt] table[x=cdf, y=speedup-barrier, col sep=comma] {11b.csv};
                \addplot+[ayellow, draw=none, bar shift=-4pt] table[x=cdf, y=speedup-nullmsg, col sep=comma] {11b.csv};
                \addplot+[agreen, draw=none, bar shift=4pt] table[x=cdf, y=speedup-unison-8, col sep=comma] {11b.csv};
                \addplot+[ared, draw=none, bar shift=12pt] table[x=cdf, y=speedup-unison-16, col sep=comma] {11b.csv};
            \end{axis}
        \end{tikzpicture}}{\texttt{11b.csv} not found, please run \texttt{./process.py 11b} first}
    \caption{\bf Figure 11b}
\end{figure}

\begin{figure}[h]
    \IfFileExists{13a.csv}{
        \begin{tikzpicture}
            \begin{axis}[
                    width=\linewidth,
                    height=0.6\linewidth,
                ...
                \addplot[ablue, very thick] table[x=x, y=ev-barrier, col sep=comma] {13a.csv};
                \addplot[ayellow, very thick] table[x=x, y=ev-nullmsg, col sep=comma] {13a.csv};
                \addplot[ared, very thick] table[x=x, y=ev-unison, col sep=comma] {13a.csv};
            \end{axis}
        \end{tikzpicture}
    }{\texttt{13a.csv} not found, please run \texttt{./process.py 13a} first}
    \caption{\bf Figure 13a}
\end{figure}

\begin{figure}[h]
    \IfFileExists{13b.csv}{
        \begin{tikzpicture}
            \begin{axis}[
                    width=\linewidth,
                    height=0.6\linewidth,
                ...
                \addplot[ablue, very thick] table[x=x, y=e2ed-barrier, col sep=comma] {13b.csv};
                \addplot[ayellow, very thick] table[x=x, y=e2ed-nullmsg, col sep=comma] {13b.csv};
                \addplot[ared, very thick] table[x=x, y=e2ed-unison, col sep=comma] {13b.csv};
            \end{axis}
        \end{tikzpicture}
    }{\texttt{13b.csv} not found, please run \texttt{./process.py 13b} first}
    \caption{\bf Figure 13b}
\end{figure}

\begin{figure}[h]
    \IfFileExists{14a.csv}{
        \begin{tikzpicture}
            \begin{axis}[
                    width=0.9\linewidth,
                    height=0.6\linewidth,
                ...
                \addplot[ablue,mark=square*,mark size=1.5pt] table[x=system,y=t,col sep=comma] {14a.csv};
            \end{axis}
            \begin{axis}[
                    width=0.9\linewidth,
                    height=0.6\linewidth,
                ...
                \addplot[ared,mark=*,mark size=1.5pt,thick] table[x=system,y=miss,col sep=comma] {14a.csv};
            \end{axis}
        \end{tikzpicture}}{\texttt{14a.csv} not found, please run \texttt{./process.py 14a} first}
    \caption{\bf Figure 14a}
\end{figure}

\begin{figure}[h]
    \IfFileExists{14b.csv}{
        \begin{tikzpicture}
            \begin{axis}[
                ...
                \addplot[ayellow,mark=*,thick] table[x=core,y=slowdown-ByPendingEventCount,col sep=comma] {14b.csv};
                \addplot[ared,mark=triangle*,thick] table[x=core,y=slowdown-ByExecutionTime,col sep=comma] {14b.csv};
                \addplot[ablue,mark=square*,thick] table[x=core,y=slowdown-None,col sep=comma] {14b.csv};
            \end{axis}
        \end{tikzpicture}}{\texttt{14b.csv} not found, please run \texttt{./process.py 14b} first}
    \caption{\bf Figure 14b}
\end{figure}
